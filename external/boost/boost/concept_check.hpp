...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct Integer< ::boost_part::long_long_type> {};
  template <> struct Integer< ::boost_part::ulong_long_type> {};
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct SignedInteger< ::boost_part::long_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct UnsignedInteger< ::boost_part::ulong_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
#define BOOST_DEFINE_BINARY_OPERATOR_CONSTRAINT(OP,NAME)    \
  ...
  BOOST_concept(Generator,(Func)(Return))
  {
   ...
   private:
      void test(boost_part::mpl::false_)
      {
      ...
      void test(boost_part::mpl::true_)
      {
          f();
      }
  ...
  BOOST_concept(UnaryFunction,(Func)(Return)(Arg))
  {
   ...
   private:
      ...
      // (warning: non-static reference "const double& boost_part::UnaryFunction<YourClassHere>::arg"
  ...
  BOOST_concept(BinaryFunction,(Func)(Return)(First)(Second))
  {
   ...
   private:
      ...
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& boost_part::BinaryFunction<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryFunction();
#endif
  ...
  BOOST_concept(UnaryPredicate,(Func)(Arg))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& boost_part::UnaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      UnaryPredicate();
#endif
  ...
  BOOST_concept(BinaryPredicate,(Func)(First)(Second))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& boost_part::BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryPredicate();
#endif
    Func f;
    ...
    : BinaryPredicate<Func, First, Second>
  {
   ...
   private:
    void const_constraints(const Func& fun) {
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& boost_part::Const_BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(SimpleAssociativeContainer)
      {
          typedef typename C::key_type key_type;
          typedef typename C::value_type value_type;
          BOOST_MPL_ASSERT((boost_part::is_same<key_type,value_type>));
      }
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(PairAssociativeContainer)
      {
          ...
          BOOST_MPL_ASSERT((boost_part::is_same<value_type,required_value_type>));
      }
  };
  ...
  BOOST_concept(Collection,(C))
  {
      ...
      {
        boost_part::function_requires<boost_part::InputIteratorConcept<iterator> >();
        boost_part::function_requires<boost_part::InputIteratorConcept<const_iterator> >();
        boost_part::function_requires<boost_part::CopyConstructibleConcept<value_type> >();
        const_constraints(c);
        i = c.begin();
        i = c.end();
        c.swap(c);

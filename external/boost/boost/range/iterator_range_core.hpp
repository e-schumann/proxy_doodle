...
namespace boost_part {} namespace boost = boost_part; namespace boost_part
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( boost_part::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( boost_part::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( boost_part::begin(l),
                                                 boost_part::end(l),
                                                 boost_part::begin(r),
                                                 boost_part::end(r) );
        }
...
incrementable_t test_traversal_tag(boost_part::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(boost_part::bidirectional_traversal_tag);
random_access_t test_traversal_tag(boost_part::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef boost_part::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef boost_part::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef boost_part::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *boost_part::prior(this->m_End);
    }
...
public:
    typedef BOOST_DEDUCED_TYPENAME
        boost_part::mpl::if_<
            boost_part::mpl::or_<
                boost_part::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                boost_part::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                boost_part::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                boost_part::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME boost_part::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME boost_part::enable_if<
            mpl::not_<boost_part::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, boost_part::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = boost_part::begin( r ),
                    new_end   = boost_part::end( r );
        ...
        */
        ...
        {
            return SeqT( boost_part::begin( r ), boost_part::end( r ) );
        }

...
namespace boost_part {} namespace boost = boost_part; namespace boost_part
{
    namespace range_detail
    {
        ...
        inline typename ::boost_part::enable_if<
        ...
        range_calculate_size(const SinglePassRange& rng)
        {
            return std::distance(boost_part::begin(rng), boost_part::end(rng));
        }
    }
...
// but only on the Mac!
        ...
        BOOST_RANGE_CONCEPT_ASSERT((boost_part::SinglePassRangeConcept<SinglePassRange>));
#endif

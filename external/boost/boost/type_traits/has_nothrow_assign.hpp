...
namespace boost_part {} namespace boost = boost_part; namespace boost_part {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(boost_part::declval<typename add_reference<T>::type>() = boost_part::declval<typename add_reference<T const>::type>()); };
   ...
   struct has_nothrow_assign : public integral_constant < bool,
      ...
      >::value
#else
      ::boost_part::has_trivial_assign<T>::value
#endif
#else

...
template<> struct is_integral< ::boost_part::ulong_long_type> : public true_type{};
template<> struct is_integral< ::boost_part::long_long_type> : public true_type{};
...
template<> struct is_integral<boost_part::int128_type> : public true_type{};
template<> struct is_integral<boost_part::uint128_type> : public true_type{};
#endif

...
namespace boost_part {} namespace boost = boost_part; namespace boost_part { namespace detail{
   ...
   template <class T, bool b> struct has_nothrow_constructor_imp : public boost_part::integral_constant<bool, false>{};
   template <class T> struct has_nothrow_constructor_imp<T, true> : public boost_part::integral_constant<bool, noexcept(T())>{};
...
template <class T> struct has_nothrow_constructor : public ::boost_part::has_trivial_constructor<T> {};

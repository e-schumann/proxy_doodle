...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<boost_part::is_void<From>, boost_part::is_function<To>, boost_part::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(boost_part::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::boost_part::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::boost_part::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static boost_part::type_traits::no_type _m_check(any_conversion ...);
    static boost_part::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( boost_part::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::boost_part::type_traits::yes_type);
#else
    static bool const value =
        sizeof( boost_part::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::boost_part::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::boost_part::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::boost_part::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::boost_part::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::boost_part::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::boost_part::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::boost_part::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::boost_part::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::boost_part::type_traits::yes_type)
        };
#endif
};
...
{
    static ::boost_part::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::boost_part::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::boost_part::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::boost_part::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::boost_part::is_function<typename ::boost_part::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::boost_part::detail::is_convertible_basic_impl<From,To>::value && ! ::boost_part::is_array<To>::value && ! ::boost_part::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::boost_part::detail::is_convertible_basic_impl<From, To>::value && !::boost_part::is_array<To>::value && !::boost_part::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::boost_part::is_arithmetic<From>::value, 
      ::boost_part::is_arithmetic<To>::value,
      ...
      ::boost_part::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::boost_part::detail::is_convertible_impl_dispatch<From, To>::value> {};

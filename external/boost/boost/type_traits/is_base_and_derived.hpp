...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::boost_part::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::boost_part::is_class<B>::value,
       ::boost_part::is_class<D>::value,
       ::boost_part::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::boost_part::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::boost_part::detail::is_base_and_derived_impl<Base, Derived>::value)> {};

...
namespace boost_part {} namespace boost = boost_part; namespace boost_part
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(boost_part::forward<F>(f), boost_part::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(boost_part::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      invoker& operator=(BOOST_THREAD_RV_REF(invoker) f)
      {
        if (this != &f)
        {
          f_ = boost_part::move(BOOST_THREAD_RV(f).f_);
        }
        return *this;
      }
    ...
    private:
      ...
      {
        return detail::invoke(boost_part::move(csbl::get<0>(f_)), boost_part::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(boost_part::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(boost_part::move(csbl::get<0>(f_)), boost_part::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , boost_part::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , boost_part::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(boost_part::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(boost_part::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(boost_part::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , boost_part::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) boost_part::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    class invoker<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8>
    {
      ...
      T7 v7_;
      T8 v8_;
      //::boost_part::tuple<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> f_;
    ...
    public:
      ...
      : fp_(boost_part::move(f))
      , v0_(boost_part::move(a0))
      , v1_(boost_part::move(a1))
      , v2_(boost_part::move(a2))
      , v3_(boost_part::move(a3))
      , v4_(boost_part::move(a4))
      , v5_(boost_part::move(a5))
      , v6_(boost_part::move(a6))
      , v7_(boost_part::move(a7))
      , v8_(boost_part::move(a8))
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f)
      : fp_(boost_part::move(BOOST_THREAD_RV(f).fp))
      , v0_(boost_part::move(BOOST_THREAD_RV(f).v0_))
      , v1_(boost_part::move(BOOST_THREAD_RV(f).v1_))
      , v2_(boost_part::move(BOOST_THREAD_RV(f).v2_))
      , v3_(boost_part::move(BOOST_THREAD_RV(f).v3_))
      , v4_(boost_part::move(BOOST_THREAD_RV(f).v4_))
      , v5_(boost_part::move(BOOST_THREAD_RV(f).v5_))
      , v6_(boost_part::move(BOOST_THREAD_RV(f).v6_))
      , v7_(boost_part::move(BOOST_THREAD_RV(f).v7_))
      , v8_(boost_part::move(BOOST_THREAD_RV(f).v8_))
      {}

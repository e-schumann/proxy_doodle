...
{
   return ::boost_part::move_detail::addressof_impl<T>::f
      ( ::boost_part::move_detail::addr_impl_ref<T>( v ), 0 );
}
...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::boost_part::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::boost_part::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< boost_part::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const boost_part::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::boost_part::rv<T>& type; };
} // namespace detail_add_rvalue_reference

...
struct has_trivial_destructor_after_move
   : ::boost_part::move_detail::is_trivially_destructible<T>
{};

//! By default this traits returns
//! <pre>boost_part::is_nothrow_move_constructible<T>::value && boost_part::is_nothrow_move_assignable<T>::value </pre>.
//! Classes with non-throwing move constructor
//! and assignment can specialize this trait to obtain some performance improvements.
template <class T>
struct has_nothrow_move
{
   static const bool value = boost_part::move_detail::is_nothrow_move_constructible<T>::value &&
                             boost_part::move_detail::is_nothrow_move_assignable<T>::value;
};

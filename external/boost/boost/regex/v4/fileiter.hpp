...
using boost_part::BOOST_REGEX_DETAIL_NS::directory_iterator;
using boost_part::BOOST_REGEX_DETAIL_NS::file_iterator;
using boost_part::BOOST_REGEX_DETAIL_NS::mapfile;
} // namespace boost_part

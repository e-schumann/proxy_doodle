...
#define BOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_DURATION_MUST_BE_A_STD_RATIO "Second template parameter of duration must be a boost_part::ratio"
#define BOOST_CHRONO_DURATION_PERIOD_MUST_BE_POSITIVE "duration period must be positive"
#define BOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_TIME_POINT_MUST_BE_A_BOOST_CHRONO_DURATION "Second template parameter of time_point must be a boost_part::chrono::duration"
#endif
...
namespace chrono {
    ...
    template <class Duration, class Rep2,
        bool = (
                    ((boost_part::is_convertible<typename Duration::rep,
                        typename common_type<typename Duration::rep, Rep2>::type>::value))
                &&  ((boost_part::is_convertible<Rep2,
                        typename common_type<typename Duration::rep, Rep2>::type>::value))
                )
        >
...
namespace chrono {
    ...
    typedef duration<boost_part::int_least64_t, nano> nanoseconds;    // at least 64 bits needed
    typedef duration<boost_part::int_least64_t, micro> microseconds;  // at least 55 bits needed
    typedef duration<boost_part::int_least64_t, milli> milliseconds;  // at least 45 bits needed
    typedef duration<boost_part::int_least64_t> seconds;              // at least 35 bits needed
    typedef duration<boost_part::int_least32_t, ratio< 60> > minutes; // at least 29 bits needed
    typedef duration<boost_part::int_least32_t, ratio<3600> > hours;  // at least 23 bits needed
...
//----------------------------------------------------------------------------//
    ...
    template <class Rep>
    struct treat_as_floating_point : boost_part::is_floating_point<Rep> {};
                   ...
                   chrono::duration<Rep2, Period2> >
{
  typedef chrono::duration<typename common_type<Rep1, Rep2>::type,
                      typename boost_part::ratio_gcd<Period1, Period2>::type> type;
};
...
namespace chrono {
    ...
    {
    //BOOST_CHRONO_STATIC_ASSERT(boost_part::is_integral<Rep>::value, BOOST_CHRONO_A_DURATION_REPRESENTATION_MUST_BE_INTEGRAL, ());
    BOOST_CHRONO_STATIC_ASSERT(!boost_part::chrono::detail::is_duration<Rep>::value,
            BOOST_CHRONO_A_DURATION_REPRESENTATION_CAN_NOT_BE_A_DURATION, ());
    BOOST_CHRONO_STATIC_ASSERT(boost_part::ratio_detail::is_ratio<typename Period::type>::value,
    ...
    public:
     ...
     defined   BOOST_CHRONO_DURATION_DEFAULTS_TO_ZERO
        ...
        , typename boost_part::enable_if <
                    mpl::and_ <
                        boost_part::is_convertible<Rep2, rep>,
                        mpl::or_ <
...
//----------------------------------------------------------------------------//
    ...
    typename boost_part::enable_if <
        mpl::and_ <
        boost_part::is_convertible<Rep1, typename common_type<Rep1, Rep2>::type>,
        boost_part::is_convertible<Rep2, typename common_type<Rep1, Rep2>::type>
        >,
    ...
    template <class Rep1, class Period, class Rep2>
    inline BOOST_CONSTEXPR
    typename boost_part::disable_if <boost_part::chrono::detail::is_duration<Rep2>,
      typename boost_part::chrono::detail::duration_divide_result<
    ...
    template <class Rep1, class Rep2, class Period>
    inline BOOST_CONSTEXPR
    typename boost_part::disable_if <boost_part::chrono::detail::is_duration<Rep1>,
      typename boost_part::chrono::detail::duration_divide_result2<
    ...
    inline BOOST_CONSTEXPR
    typename boost_part::disable_if <boost_part::chrono::detail::is_duration<Rep2>,
      typename boost_part::chrono::detail::duration_modulo_result<
        duration<Rep1, Period>, Rep2>::type
    >::type
    operator%(const duration<Rep1, Period>& d, const Rep2& s)
    {
...
//----------------------------------------------------------------------------//
    ...
    inline BOOST_CONSTEXPR
    typename boost_part::enable_if <
      boost_part::chrono::detail::is_duration<ToDuration>, ToDuration>::type
    duration_cast(const duration<Rep, Period>& fd)
    {
        return boost_part::chrono::detail::duration_cast<

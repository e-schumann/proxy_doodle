...
# define BOOST_SYSTEM_CLOCK_DURATION boost_part::chrono::duration<boost_part::int_least64_t, ratio<BOOST_RATIO_INTMAX_C(1), BOOST_RATIO_INTMAX_C(10000000)> >
#else
# define BOOST_SYSTEM_CLOCK_DURATION boost_part::chrono::nanoseconds
#endif

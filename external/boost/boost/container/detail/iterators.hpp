...
class constant_iterator
  : public ::boost_part::container::iterator
      ...
      <std::random_access_iterator_tag, T, Difference, const T*, const T &>
{
   ...
   //constructed until ::boost_part::container::construct_in_place is called.
...
struct emplace_functor
{
   ...
   BOOST_CONTAINER_FORCEINLINE void inplace_impl(Allocator &a, T* ptr, const container_detail::index_tuple<IdxPack...>&)
   {
      allocator_traits<Allocator>::construct
         (a, ptr, ::boost_part::forward<Args>(container_detail::get<IdxPack>(args_))...);
   }
   ...
   {
      typedef typename boost_part::container::iterator_traits<DestIt>::value_type value_type;
      value_type && tmp= value_type(::boost_part::forward<Args>(container_detail::get<IdxPack>(args_))...);
      *dest = ::boost_part::move(tmp);
   }
...
{\
   ...
   {\
      ...
      *dest = ::boost_part::move(const_cast<value_type &>(BOOST_MOVE_IF(N, tmp, tmp.get())));\
   }\
   \
   BOOST_MOVE_MREF##N\
};\
...
struct iiterator_types
{
   ...
   typedef typename boost_part::container::iterator_traits<IIterator>::pointer         it_pointer;
   typedef typename boost_part::container::iterator_traits<IIterator>::difference_type difference_type;
   typedef typename ::boost_part::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<value_type>::type                      pointer;
   typedef typename ::boost_part::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<const value_type>::type                const_pointer;
   typedef typename ::boost_part::intrusive::
...
{
   typedef typename ::boost_part::container::iterator
...
using ::boost_part::intrusive::reverse_iterator;

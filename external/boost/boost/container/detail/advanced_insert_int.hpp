...
struct move_insert_range_proxy
{
   ...
   {
      this->first_ = ::boost_part::container::uninitialized_move_alloc_n_source
         (a, this->first_, n, p);
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n)
   {
      this->first_ = ::boost_part::container::move_n_source(this->first_, n, p);
   }
...
struct insert_range_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n)
   {
      this->first_ = ::boost_part::container::uninitialized_copy_alloc_n_source(a, this->first_, n, p);
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n)
   {
      this->first_ = ::boost_part::container::copy_n_source(this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  boost_part::container::uninitialized_fill_alloc_n(a, v_, n, p);  }
...
{
   typedef ::boost_part::container::allocator_traits<Allocator> alloc_traits;
   typedef typename allocator_traits<Allocator>::size_type size_type;
   typedef typename allocator_traits<Allocator>::value_type value_type;

   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {  boost_part::container::uninitialized_value_init_alloc_n(a, n, p);  }
...
struct insert_default_initialized_n_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {  boost_part::container::uninitialized_default_init_alloc_n(a, n, p);  }
...
struct insert_move_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1);  (void)n;
      alloc_traits::construct( a, iterator_to_raw_pointer(p), ::boost_part::move(v_) );
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n) const
   {
      BOOST_ASSERT(n == 1);  (void)n;
      *p = ::boost_part::move(v_);
   }
...
insert_move_proxy<Allocator, It> get_insert_value_proxy(BOOST_RV_REF(typename boost_part::container::iterator_traits<It>::value_type) v)
{
   return insert_move_proxy<Allocator, It>(v);
}

template<class It, class Allocator>
insert_copy_proxy<Allocator, It> get_insert_value_proxy(const typename boost_part::container::iterator_traits<It>::value_type &v)
{
...
struct insert_nonmovable_emplace_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1); (void)n;
      alloc_traits::construct( a, iterator_to_raw_pointer(p), ::boost_part::forward<Args>(get<IdxPack>(this->args_))... );
   }
   ...
   :  public insert_nonmovable_emplace_proxy<Allocator, Iterator, Args...>
{
   ...
   explicit insert_emplace_proxy(BOOST_FWD_REF(Args)... args)
      : base_t(::boost_part::forward<Args>(args)...)
   {}
   ...
   void priv_copy_some_and_update(Allocator &a, const index_tuple<IdxPack...>&, Iterator p, size_type n)
   {
      ...
      alloc_traits::construct(a, vp,
         ::boost_part::forward<Args>(get<IdxPack>(this->args_))...);
      BOOST_TRY{
         *p = ::boost_part::move(*vp);
      }
      BOOST_CATCH(...){
...
template<class Allocator, class Iterator>
struct insert_emplace_proxy<Allocator, Iterator, typename boost_part::container::allocator_traits<Allocator>::value_type>
   : public insert_move_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy(typename boost_part::container::allocator_traits<Allocator>::value_type &&v)
...
struct insert_emplace_proxy<Allocator, Iterator
   , typename boost_part::container::container_detail::add_const<typename boost_part::container::allocator_traits<Allocator>::value_type>::type
   >
   : public insert_copy_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy(const typename boost_part::container::allocator_traits<Allocator>::value_type &v)
...
//Specializations to avoid an unneeded temporary when emplacing from a single argument o type value_type
template<class Allocator, class Iterator>
struct insert_emplace_proxy_arg1<Allocator, Iterator, ::boost_part::rv<typename boost_part::container::allocator_traits<Allocator>::value_type> >
   : public insert_move_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy_arg1(typename boost_part::container::allocator_traits<Allocator>::value_type &v)
   : insert_move_proxy<Allocator, Iterator>(v)
   {}
};

template<class Allocator, class Iterator>
struct insert_emplace_proxy_arg1<Allocator, Iterator, typename boost_part::container::allocator_traits<Allocator>::value_type>
   : public insert_copy_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy_arg1(const typename boost_part::container::allocator_traits<Allocator>::value_type &v)
   : insert_copy_proxy<Allocator, Iterator>(v)
   {}
};

...
//! \file
//!   This header forward declares boost_part::container::constructible_with_allocator_prefix,
//!   boost_part::container::constructible_with_allocator_suffix and
//!   boost_part::container::uses_allocator. Also defines the following types:

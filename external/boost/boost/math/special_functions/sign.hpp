...
namespace detail {
  ...
  // signbit
    ...
    {
       return (boost_part::math::signbit)(static_cast<double>(x));
    }
    ...
    inline long double (changesign_impl)(long double x, generic_tag<true> const&)
    {
       ...
       pd[0] = boost_part::math::changesign(pd[0]);
       pd[1] = boost_part::math::changesign(pd[1]);
       return x;
    }
...
{
   return (z == 0) ? 0 : (boost_part::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (boost_part::math::signbit)(static_cast<result_type>(x)) != (boost_part::math::signbit)(static_cast<result_type>(y)) 
      ? (boost_part::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
